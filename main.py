...
from commands.character import character, my_characters, assign_slot, setup_team, select_team_character
...
from commands.challenge import challenge, challenge_user, accept_challenge, challenge_attack, challenge_run
...
bot.add_event_handler(my_characters, events.NewMessage(pattern='/my_characters'))
